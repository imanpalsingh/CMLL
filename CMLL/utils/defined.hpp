...
namespace linear
{
    ...
    // Flag to represent selection of ELS method for calculation of Coefficients for Linear Model
    const short ELS=0;

    // Flag to represent selection of ISLR method for calculation of Coefficients for Linear Model
    const short ISLR=1;
   ...
   const short SIGMOID_ALPHA = 8;
    ...
    // value for default method for Linear Regression
    const short DEFAULT_LINEAR_REGRESSION_METHOD = ELS;
